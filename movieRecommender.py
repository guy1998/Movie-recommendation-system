...
import pandas as pd
# sklearn used to train our "model"
...
window = Tk(className=' Movie Recommendation System')

# define four labels Title Author Year ISBN
l1 = Label(window, text='Movie Recommendation System', bg='black', fg='white', pady=20, padx=20)
...
def recommend():
    ...
    for i in range(101):
        if val < 100:
            ...
            messagebox.showwarning("Done", "Please check our list! \nThank you!")
    ...
    try:
        ...
        # Reset the value so we can clear it afterward
        val = 0
        load_text.set('35 Results were found')

        # Step 8: Print titles of first 35 movies
        i = 0
